...
let schoolId = window.location.search.split("&")[2].split("=")[1];
let collegeId = window.location.search.split("&")[3].split("=")[1];
            ...
            auditForm = new Form('#auditWindow', {
                ...
                onSubmit: function () {
                    ...
                    auditApplication(t).then((data) => {
                        let sendParam = {}
                        sendParam.schoolId = schoolId;
                        sendParam.collegeId = collegeId;
                        //发送消息
                        if (ifSend) {
                            ...
                            sendParam.messageNodeId = [applyId]
